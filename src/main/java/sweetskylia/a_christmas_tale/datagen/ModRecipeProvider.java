    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup wrapperLookup, RecipeExporter recipeExporter) {
        return new RecipeGenerator(wrapperLookup, recipeExporter) {
            ...
            public void generate() {
                ...
                offerSmelting(STELLAR_HEART_SMELTABLES, RecipeCategory.MISC, ModItems.STELLAR_HEART, 0.25f, 200, "stellar_heart");
                offerBlasting(STELLAR_HEART_SMELTABLES, RecipeCategory.MISC, ModItems.STELLAR_HEART, 0.25f, 100, "stellar_heart");

                //Stellar Block
                offerReversibleCompactingRecipes(RecipeCategory.MISC, ModItems.STELLAR_HEART, RecipeCategory.BUILDING_BLOCKS, ModBlocks.STELLAR_BLOCK);
                //Frozen Stellar Block
                offerReversibleCompactingRecipes(RecipeCategory.MISC, ModItems.FROZEN_STELLAR_HEART, RecipeCategory.BUILDING_BLOCKS, ModBlocks.FROZEN_STELLAR_BLOCK);

                //Winter Carpet
                createShaped(RecipeCategory.DECORATIONS, ModBlocks.WINTER_CARPET, 3)
                        .pattern("WW")
                        .input('W', ModBlocks.WINTER_WOOL)
                        .criterion(hasItem(ModBlocks.WINTER_WOOL), conditionsFromItem(ModBlocks.WINTER_WOOL))
                        .offerTo(exporter);
                //Christmas Carpet
                createShaped(RecipeCategory.DECORATIONS, ModBlocks.CHRISTMAS_CARPET, 3)
                        .pattern("WW")
                ...
                //Christmas Wool
                createShaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHRISTMAS_WOOL, 8)
                        .pattern("WWW")
                        .pattern("WHW")
                        .pattern("WWW")
                ...
                //Wintel Wool
                createShaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.WINTER_WOOL, 8)
                        .pattern("WWW")
                        .pattern("WHW")
                        .pattern("WWW")
                        .input('W', ItemTags.WOOL)
                ...
                createShaped(RecipeCategory.TOOLS, ModItems.STELLAR_CANDY_PICKAXE, 1)
                        .pattern("CCC")
                        .pattern(" F ")
                        .pattern(" | ")
                        .input('|', Items.STICK)
                ...
                createShaped(RecipeCategory.TOOLS, ModItems.STELLAR_CANDY_AXE, 1)
                        .pattern("CC")
                        .pattern("FC")
                        .pattern("| ")
                        .input('|', Items.STICK)
                ...
                createShaped(RecipeCategory.TOOLS, ModItems.STELLAR_CANDY_SHOVEL, 1)
                        .pattern("C")
                        .pattern("F")
                        .pattern("|")
                        .input('|', Items.STICK)
                ...
                createShaped(RecipeCategory.TOOLS, ModItems.STELLAR_CANDY_HOE, 1)
                        .pattern("CC")
                        .pattern(" F")
                        .pattern(" |")
                        .input('|', Items.STICK)
                ...
                createShaped(RecipeCategory.TOOLS, ModItems.STELLAR_CANDY_SWORD, 1)
                        .pattern(" C")
                        .pattern(" F")
                        .pattern(" |")
                        .input('|', Items.STICK)
                ...
                createShaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.STELLAR_ICE, 1)
                        .pattern(" IF")
                ...
                //WOOD RECIPES ======================================
                registerPlankRecipes(); //logs to planks
                ...
                offerSlabRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.RED_OMORIKA_SLAB, ModBlocks.RED_OMORIKA_PLANKS);
                offerSlabRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.SHIROMORIKA_SLAB, ModBlocks.SHIROMORIKA_PLANKS);
                ...
                offerPressurePlateRecipe(ModBlocks.RED_OMORIKA_PRESSURE_PLATE, ModBlocks.RED_OMORIKA_PLANKS);
                offerPressurePlateRecipe(ModBlocks.SHIROMORIKA_PRESSURE_PLATE, ModBlocks.SHIROMORIKA_PLANKS);

                offerShapelessRecipe(ModBlocks.RED_OMORIKA_BUTTON, ModBlocks.RED_OMORIKA_PLANKS, RecipeCategory.REDSTONE.getName(), 1);
                offerShapelessRecipe(ModBlocks.SHIROMORIKA_BUTTON, ModBlocks.SHIROMORIKA_PLANKS, RecipeCategory.REDSTONE.getName(), 1);
                ...
                //Candy / Smelting
                offerSmelting(List.of(Items.SUGAR), RecipeCategory.FOOD, ModItems.CANDY, 0.1f, 200, "candy_from_smelting");
                //Candy / CandyBlock
                offerReversibleCompactingRecipes(RecipeCategory.FOOD, ModItems.CANDY, RecipeCategory.BUILDING_BLOCKS, ModBlocks.CANDY_BLOCK);
                ...
                SmithingTransformRecipeJsonBuilder.create(Ingredient.ofItems(Items.PAPER), Ingredient.ofItems(Items.IRON_SWORD), Ingredient.ofItems(ModItems.FROZEN_STELLAR_HEART), RecipeCategory.TOOLS, ModItems.FROZEN_SWORD)
                        .criterion(hasItem(ModItems.FROZEN_STELLAR_HEART), conditionsFromItem(ModItems.FROZEN_STELLAR_HEART))
                        .offerTo(exporter, Identifier.of(AChristmasTale.MOD_ID, "frozen_sword_from_smithing").toString());

                //Hot Chocolate
                createShaped(RecipeCategory.FOOD, ModItems.HOT_CHOCOLATE)
                        .pattern("SC")
                        .input('S', Items.SUGAR)
                ...
                //SnowFlake
                createShaped(RecipeCategory.COMBAT, ModItems.SNOWFLAKE, 4)
                        .pattern(" S ")
                        .pattern("SFS")
                        .pattern(" S ")
                ...
                //Frozen Fruit Pie
                createShapeless(RecipeCategory.FOOD, ModItems.FROZEN_FRUIT_PIE, 2)
                        .input(Items.SUGAR)
                        .input(Items.EGG)
            ...
            private void registerWoodRecipes(RecipeExporter exporter) {
            ...
            private void registerPlankRecipes() {
                ...
                logToPlanks.forEach((log, plank) ->
                        offerShapelessRecipe(plank, log, RecipeCategory.BUILDING_BLOCKS.getName(), 4)
                );
            }

            private void registerOrnaments(RecipeExporter exporter) {
                ...
                ornamentsCraft.forEach((dye, ornament) ->
                        ...
                        createShaped(RecipeCategory.DECORATIONS, ornament, 6)
                                .pattern("GSG")
                                .pattern("GDG")
                                .pattern("GGG")
