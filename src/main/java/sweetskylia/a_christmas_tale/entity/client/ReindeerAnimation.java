...
public class ReindeerAnimation {
    ...
    public static final Animation ANIM_REINDEER_IDLE = Animation.Builder.create(1.5f).looping()
    ...
    public static final Animation ANIM_REINDEER_WALKING = Animation.Builder.create(1f).looping()
